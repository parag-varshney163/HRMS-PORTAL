...
const AdminResignations = () => {
  ...
  const renderStatusBadge = (status) => {
    ...
    return (
      <span
        style={style}
        className="text-[10px] sm:text-xs font-bold px-3 py-1 rounded-md border uppercase tracking-wider"
      >
        {text}
      </span>
    );
  ...
  <div className="py-2 pb-6 w-full h-full flex flex-col animate-in fade-in">
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
      <div>
        ...
        >
          Employee{" "}
          <span style={{ color: colors.accentDark }}>Resignations</span>
        </h2>
    ...
    <div
      className="flex justify-start pb-4 mb-4"
            ...
            return (
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  <div className="flex items-center gap-3">
                    <div
                      className="w-11 h-11 rounded-full border-2 flex items-center justify-center text-sm font-semibold shrink-0 uppercase"
                      style={{
